...
aws s3 cp ../SLDB/build/libs/SLDB-0.1.0.jar s3://my-new-lambda-bucket-6328764287364/
aws s3 cp ../SLDB/build/distributions/dependencies.zip s3://my-new-lambda-bucket-6328764287364/
