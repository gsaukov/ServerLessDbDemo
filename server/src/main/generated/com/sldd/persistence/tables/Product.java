...
public class Product extends TableImpl<ProductRecord> {
     ...
     */
    public final TableField<ProductRecord, String> CATEGORY = createField(DSL.name("category"), SQLDataType.VARCHAR(180).nullable(false), this, "");

    /**
     * The column <code>public.product.name</code>.
     */
    public final TableField<ProductRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(180).nullable(false), this, "");
     ...
     */
    public final TableField<ProductRecord, String> TYPE = createField(DSL.name("type"), SQLDataType.VARCHAR(120).nullable(false), this, "");
    ...
    public UniqueKey<ProductRecord> getPrimaryKey() {
        return Internal.createUniqueKey(Product.PRODUCT, DSL.name("PRODUCT_pkey"), new TableField[] { Product.PRODUCT.ID }, true);
    }
